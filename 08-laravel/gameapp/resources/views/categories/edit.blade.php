...
<section class="scroll">
    <form action="{{ url('categories/' .$category->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" placeholder="12323456" value="{{old('name', $category->name)}}">
        </div>
        <div class="form-group">
            <label>
            ...
            <input type="text" name="manufacturer" placeholder="nintendo" value="{{old('manufacturer' , $category->manufacturer)}}">
        </div> 
        <div class="form-group">
            <label>
            ...
            <input type="text" value="{{old('releasedate' , $category->releasedate)}}" name="releasedate" placeholder="1980-10-10">
        </div>
        <div class="form-group">
            <label>
                <img src="{{ asset ('images/ico-email-register.svg') }}" alt="description">
                Description:
            </label>
            <input type="text" name="description" value="{{old('description' , $category->description)}}" placeholder="lorem ipsum">
        </div>      
        <div class="form-group">
            <button type="submit">
